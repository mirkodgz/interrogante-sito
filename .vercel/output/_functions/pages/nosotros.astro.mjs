...
import 'react';
import { M as MotionPreset, S as SectionHeader } from '../chunks/SectionHeader_DcC6qSMl.mjs';
...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Nosotros - Interrogante Spettacolo" }, { "default": async ($$result2) => renderTemplate` ${maybeRenderHead()}<main> ${renderComponent($$result2, "AboutHero", AboutHero, { "client:load": true, "client:component-hydration": "load", "client:component-path": "C:/Users/HP-LAPTOP/Desktop/interrogante-sito/src/components/blocks/AboutHero", "client:component-export": "default" })} ${renderComponent($$result2, "AboutDescription", AboutDescription, { "client:load": true, "client:component-hydration": "load", "client:component-path": "C:/Users/HP-LAPTOP/Desktop/interrogante-sito/src/components/blocks/AboutDescription", "client:component-export": "default" })} ${renderComponent($$result2, "TeamList", TeamList, { "client:load": true, "teamMembers": teamMembers, "client:component-hydration": "load", "client:component-path": "C:/Users/HP-LAPTOP/Desktop/interrogante-sito/src/components/blocks/TeamList", "client:component-export": "default" })} </main> ` })}`;
}, "C:/Users/HP-LAPTOP/Desktop/interrogante-sito/src/pages/nosotros/index.astro", void 0);

const $$file = "C:/Users/HP-LAPTOP/Desktop/interrogante-sito/src/pages/nosotros/index.astro";
const $$url = "/nosotros";
