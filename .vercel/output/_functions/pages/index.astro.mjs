...
import 'piccolore';
import { b as cn, a as getCollection, $ as $$Layout } from '../chunks/Layout_HUSFDQDr.mjs';
import { jsx, jsxs } from 'react/jsx-runtime';
import React__default, { useState, useEffect } from 'react';
import { motion } from 'framer-motion';
import { S as SectionHeader, M as MotionPreset } from '../chunks/SectionHeader_C9zL316p.mjs';
import { B as BrandButton } from '../chunks/BrandButton_BlsFB2BL.mjs';
import Autoplay from 'embla-carousel-autoplay';
import { C as Carousel, a as CarouselContent, b as CarouselItem } from '../chunks/carousel__vx1qk3N.mjs';
...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Home" }, { "default": async ($$result2) => renderTemplate` ${maybeRenderHead()}<main>  ${renderComponent($$result2, "Hero", Hero, { "client:load": true, "client:component-hydration": "load", "client:component-path": "D:/interrogante-sitoweb/src/components/blocks/Hero", "client:component-export": "default" })}  ${renderComponent($$result2, "TextStrips", TextStrips, { "client:load": true, "client:component-hydration": "load", "client:component-path": "D:/interrogante-sitoweb/src/components/blocks/TextStrips", "client:component-export": "default" })}  ${renderComponent($$result2, "PortfolioSection", Portfolio, { "client:load": true, "portfolioItems": portfolioItems, "client:component-hydration": "load", "client:component-path": "D:/interrogante-sitoweb/src/components/blocks/PortfolioSection", "client:component-export": "default" })}  ${renderComponent($$result2, "AboutSection", AboutSection, { "client:load": true, "client:component-hydration": "load", "client:component-path": "D:/interrogante-sitoweb/src/components/blocks/AboutSection", "client:component-export": "default" })}  ${renderComponent($$result2, "FestivalCTA", FestivalCTA, { "client:load": true, "client:component-hydration": "load", "client:component-path": "D:/interrogante-sitoweb/src/components/blocks/FestivalCTA", "client:component-export": "default" })}  ${renderComponent($$result2, "NewsSection", NewsSection, { "client:load": true, "client:component-hydration": "load", "client:component-path": "D:/interrogante-sitoweb/src/components/blocks/NewsSection", "client:component-export": "default" })}  ${renderComponent($$result2, "BlogSection", BlogSection, { "client:load": true, "blogItems": blogItems, "client:component-hydration": "load", "client:component-path": "D:/interrogante-sitoweb/src/components/blocks/BlogSection", "client:component-export": "default" })} </main> ` })}`;
}, "D:/interrogante-sitoweb/src/pages/index.astro", void 0);

const $$file = "D:/interrogante-sitoweb/src/pages/index.astro";
const $$url = "";
